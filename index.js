const pets = [
   {
      id: 1,
      title: "Jennifer",
      img: "assets/our-friends/pets-jennifer.png",
      type: "Dog",
      breed: "Labrador",
   ...
   },
   {
      id: 2,
      name: "Sophia",
      img: "assets/our-friends/pets-sophia.png",
      type: "Dog",
      breed: "Shih tzu",
   ...
   },
   {
      id: 3,
      name: "Woody",
      img: "assets/our-friends/pets-woody.png",
      type: "Dog",
   ...
   },
   {
      id: 4,
      name: "Scarlett",
      img: "assets/our-friends/pets-scarlet.png",
      type: "Dog",
   ...
   },
   {
      id: 5,
      name: "Katrine",
      img: "assets/our-friends/pets-katrine.png",
      type: "Cat",
   ...
   },
   {
      id: 6,
      name: "Timmy",
      img: "assets/our-friends/pets-timmy.png",
      type: "Cat",
      breed: "British Shorthair",
   ...
   },
   {
      id: 7,
      name: "Freddie",
      img: "assets/our-friends/pets-freddy.png",
      type: "Cat",
      breed: "British Shorthair",
   ...
   },
   {
      id: 8,
      name: "Charly",
      img: "assets/our-friends/pets-charly.png",
      type: "Dog",
      breed: "Jack Russell Terrier",
...
const toHTML = pet => `
   <div class="our-friends__card pet-card" id=${pet.id}>
...
const modal = $.modal({
   closable: true,
   // image: `<img src="assets/our-friends/pets-jennifer.png" class="modal__image">`
   // ,
   // name: 'Jennifer',
   // type: 'dog',
   // breed: 'Labrador',
